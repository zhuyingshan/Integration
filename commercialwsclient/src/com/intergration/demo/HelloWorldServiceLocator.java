...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements com.intergration.demo.HelloWorldService {
    ...
    public com.intergration.demo.HelloWorld_PortType getHelloWorld() throws javax.xml.rpc.ServiceException {
    ...
    public com.intergration.demo.HelloWorld_PortType getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.intergration.demo.HelloWorldSoapBindingStub _stub = new com.intergration.demo.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.intergration.demo.HelloWorld_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.intergration.demo.HelloWorldSoapBindingStub _stub = new com.intergration.demo.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://commercial", "HelloWorldService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://commercial", "HelloWorld"));
        }
