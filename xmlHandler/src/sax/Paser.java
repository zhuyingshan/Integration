...
public class Paser {
    public void paserUnitedStudent(String fileName) {
    ...
    public void paserSoftwareStudent(String fileName) {
        File inputXml = new File(fileName);
        SAXReader saxReader = new SAXReader();
        ArrayList<Student> list= new ArrayList<>();
        try{
    ...
    public void paserCommerceStudent(String fileName){
        File inputXml = new File(fileName);
        SAXReader saxReader = new SAXReader();
        ArrayList<Student> list= new ArrayList<>();
        try{
    ...
    public void paserMathStudent(String fileName){
        File inputXml = new File(fileName);
        SAXReader saxReader = new SAXReader();
        ArrayList<Student> list = new ArrayList<>();
        try{
    ...
    public void paserUniteCourse(String fileName){
        File inputXml = new File(fileName);
        SAXReader saxReader = new SAXReader();
    ...
    public void paserSoftwareCourse(String fileName){
        File inputXml = new File(fileName);
        SAXReader saxReader = new SAXReader();
        ArrayList<Course> list =new ArrayList<>();
        try{
    ...
    public void paserCommerceCourse(String fileName){
        File inputXml = new File(fileName);
        SAXReader saxReader = new SAXReader();
        ArrayList<Course> list =new ArrayList<>();
        try{
    ...
    public void paserMathCourse(String fileName){
        File inputXml = new File(fileName);
        SAXReader saxReader = new SAXReader();
        ArrayList<Course> list =new ArrayList<>();
        try{
    ...
    public void paserUnteSelection(String fileName){
        File inputXml = new File(fileName);
        SAXReader saxReader = new SAXReader();
    ...
    public void paserSoftwareSelection(String fileName){
        File inputXml = new File(fileName);
        SAXReader saxReader = new SAXReader();
        ArrayList<Selection> list =new ArrayList<>();
        try{
    ...
    public void paserCommerceSelection(String fileName){
        File inputXml = new File(fileName);
        SAXReader saxReader = new SAXReader();
        ArrayList<Selection> list =new ArrayList<>();
        try{
    ...
    public void paserMathSelection(String fileName){
        File inputXml = new File(fileName);
        SAXReader saxReader = new SAXReader();
        ArrayList<Selection> list =new ArrayList<>();
        try{
